...
class CategoryService {
  ...
  Future<Map<String, dynamic>> createCategory({required String categoryName, List<String>? images}) async {
    final url = Uri.parse('$_baseUrl/categories');
    ...
    try {
      final response = await http.post(
        ...
        body: jsonEncode({'category_name': categoryName, 'images': images ?? []}),
      );
