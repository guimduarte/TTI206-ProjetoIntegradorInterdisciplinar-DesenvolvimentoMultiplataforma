...
class CategoryService {
  ...
  Future<List<GroupModel>> getCategories() async {
    final url = Uri.parse('$_baseUrl/categories-images');
  ...
  Future<Map<String, dynamic>> fetchCategories() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final errorMessage =
            responseBody['detail'] ??
            'Falha ao buscar categorias. Status: ${response.statusCode}';
        return {"error": true, "message": errorMessage};
      }
    } on SocketException {
      return {
        "error": true,
        "message": "Erro de conexão: Servidor de categorias inacessível.",
      };
    } catch (e) {
      return {
        "error": true,
        "message": "Erro inesperado ao listar categorias. ($e)",
      };
    }
  }
  ...
  Future<Map<String, dynamic>> fetchAvailableImages() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final responseBody = json.decode(response.body);
        final errorMessage =
            responseBody['detail'] ?? 'Falha ao buscar lista de imagens.';
        return {"error": true, "message": errorMessage};
      }
    } on SocketException {
      ...
      return {
        "error": true,
        "message": "Erro inesperado ao listar imagens. ($e)",
      };
    }
  }
  ...
  Future<Map<String, dynamic>> createCategory({
    ...
    if (token == null) {
      return {"error": true, "message": "Houve um erro ao obter o token"};
    }
    try {
      ...
      if (response.statusCode == 201) {
        ...
        final errorMessage =
            responseBody['detail'] ??
            'Erro ao criar categoria. Status: ${response.statusCode}';
        return {"error": true, "message": errorMessage};
      }
    } on SocketException {
      return {
      ...
      return {
        "error": true,
        "message": "Erro inesperado ao criar categoria. ($e)",
      };
    }
  }
  ...
  Future<Map<String, dynamic>> deleteCategory({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final errorMessage =
            responseBody['detail'] ??
            'Falha ao deletar categoria. Status: ${response.statusCode}';
        return {"error": true, "message": errorMessage};
      }
    } on SocketException {
      return {
      ...
      return {
        "error": true,
        "message": "Erro inesperado ao deletar categoria. ($e)",
      };
    }
  }
  ...
  Future<Map<String, dynamic>> updateCategory({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final errorMessage =
            responseBody['detail'] ??
            'Falha ao atualizar categoria. Status: ${response.statusCode}';
        return {"error": true, "message": errorMessage};
      }
    } on SocketException {
      return {
      ...
      return {
        "error": true,
        "message": "Erro inesperado durante a atualização. ($e)",
      };
    }
  }
}
