      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              // ====== Upload de Imagens ======
              const Text("Upload de Imagens", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
              ElevatedButton(
                onPressed: () {
                  // Aqui só adiciona um nome de imagem de exemplo
                  setState(() {
              ...
              Wrap(
                spacing: 8,
                children: imagens.map((img) => Chip(label: Text(img))).toList(),
              ),

              const Divider(height: 32),

              // ====== Criação de Temas ======
              const Text("Criação de Temas", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
              TextField(
              ...
              // ====== Edição de Temas ======
              const Text("Temas Criados", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
